...
//    await expect(NFTTester.callNFTBidding()).to.emit(NFTTester, 'NFTTokenID').withArgs(tokenIDMatch)
  ...
  it('BidFeswaPair: NFT list content checking', async () => {
    ...
    expect(receipt.gasUsed).to.eq('300430')       // 320400 319620 319655 318898 296401 296358 294851 295514
    ...
    receipt = await bidtx.wait()
    expect(receipt.gasUsed).to.eq('106510')     //111813  111033 111063 110632 103063 103020  101513 103122 98922
